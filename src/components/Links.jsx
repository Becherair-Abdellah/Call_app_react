...
export default function Links() {
  return (
    ...
    transition={{ duration: 0.3 }} className='block bg-gray-50 shadow-lg lg:shadow-none lg:flex lg:justify-between lg:items-center lg:gap-3 text-start text-gray-500 p-2 px-8 rounded-lg absolute lg:relative right-10 '>
      <ul className="" >
